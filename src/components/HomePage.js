                    ...
                    <div className="absolute top-16 left-24 ">
                        <div className="pt-20">
                            <div className="text-center flex flex-col">
                                ...
                                <button onClick={() => history.push('/form/')} className="text-white mb-5 rounded-md px-5 py-3 bg-gradient-to-r from-green-600 to-green-300 hover:from-green-800 hover:to-green-500">Disease Prediction</button>
                                <button onClick={() => history.push('/map/')} className="text-white mb-5 rounded-md px-5 py-3 bg-gradient-to-r from-green-600 to-green-300 hover:from-green-800 hover:to-green-500">Hospital Finder</button>
                            </div>
                        </div>
                    </div>
                </div>
